...
<footer class="footer">
	<div class="container bottom_border">
		<div class="row">
			<div class=" col-sm-4 col-md col-sm-4  col-12 col">
				...
				<p><i class="fa fa-location-arrow"></i> manulalapet, venkatagiri - 524132 </p>
				<p><i class="fa fa-phone"></i>  +91-8888888888  </p>
				<p><i class="fa fa fa-envelope"></i> manulalapet@gmail.com  </p>
			</div>
			...
			<div class=" col-sm-4 col-md  col-12 col">
				...
				<ul class="footer_ul2_amrc">
					<li><a href="#"><i class="fa fa-bicycle fleft padding-right"></i> </a><p>Lorem Ipsum is simply dummy text of the printing...<a href="#">https://www.lipsum.com/</a></p></li>
	...
	<div class="container">
		...
		<p class="text-center">Copyright @2019 | Designed With by <a href="#">pk solutions pvt ltd.</a></p>
